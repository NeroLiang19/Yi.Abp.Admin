...
public class AccountFrameworkRbacTest : YiFrameworkRbacTestWebBase
{
    ...
    public async Task Register_Test()
    {
        await _accountService.PostRegisterAsync(new RegisterDto
            { UserName = "RegisterTest", Password = "123456", Phone = 15945645645 });
    ...
    public async Task Register_UserNameRepeat_Error_Test()
    {
        ...
        {
            await _accountService.PostRegisterAsync(new RegisterDto
                { UserName = "RegisterUserNameRepeatErrorTest", Password = "123456", Phone = 15945645641 });
            await _accountService.PostRegisterAsync(new RegisterDto
                { UserName = "RegisterUserNameRepeatErrorTest", Password = "123456", Phone = 15945645642 });
        }
    ...
    public async Task Register_PhoneRepeat_Error_Test()
    {
        ...
        {
            await _accountService.PostRegisterAsync(new RegisterDto
                { UserName = "RegisterPhoneRepeatErrorTest1", Password = "123456", Phone = 15945645633 });
            await _accountService.PostRegisterAsync(new RegisterDto
                { UserName = "RegisterPhoneRepeatErrorTest2", Password = "123456", Phone = 15945645633 });
        }
        catch (UserFriendlyException ex)
        {
    ...
    {
        await _accountService.PostRegisterAsync(new RegisterDto
            { UserName = "LoginTest", Password = "123456", Phone = 13845645645 });
        var result =
            await _accountService.PostLoginAsync(new LoginInputVo { UserName = "LoginTest", Password = "123456" });
    ...
    {
        await _accountService.PostRegisterAsync(new RegisterDto
            { UserName = "ResetPassworldTest", Password = "123456", Phone = 15945645555 });
        ...
        var result = await _accountService.PostLoginAsync(new LoginInputVo
            { UserName = "ResetPassworldTest", Password = "654321abc" });
    }
}