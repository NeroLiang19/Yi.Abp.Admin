    ...
    IDictionaryTypeService
{
    ...
    protected override async Task CheckCreateInputDtoAsync(DictionaryTypeCreateInputVo input)
    {
        ...
        if (isExist) throw new UserFriendlyException(DictionaryConst.Exist);
    }

    protected override async Task CheckUpdateInputDtoAsync(DictionaryTypeAggregateRoot entity,
        DictionaryTypeUpdateInputVo input)
    {
