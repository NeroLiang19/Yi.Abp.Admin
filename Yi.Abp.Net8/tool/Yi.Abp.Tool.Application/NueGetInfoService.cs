...
{
    private readonly NugetCrawlerManager _nugetCrawlerManager;

    public NueGetInfoService(NugetCrawlerManager nugetCrawlerManager)
    {
        _nugetCrawlerManager = nugetCrawlerManager;
    }
