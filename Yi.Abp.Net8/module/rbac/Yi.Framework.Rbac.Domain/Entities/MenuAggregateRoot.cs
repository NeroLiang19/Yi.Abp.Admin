...
/// </summary>
[SugarTable("Menu")]
public class MenuAggregateRoot : AggregateRoot<Guid>, ISoftDelete, IAuditedObject, IOrderNum, IState
{
    ...
    public static List<Vue3PureRouterDto> Vue3PureRouterBuild(this List<MenuAggregateRoot> menus)
    {
        ...
        var allRouters = menus
            ...
            .Select(m => new Vue3PureRouterDto
            {
                ...
                Name = m.IsLink ? "Link" : m.RouterName,
        ...
        //根路由
        if (!routerDic.TryGetValue(Guid.Empty, out var rootRouters)) return new List<Vue3PureRouterDto>();
        var stack = new Stack<Vue3PureRouterDto>(rootRouters);
        while (stack.Count > 0)
        {
