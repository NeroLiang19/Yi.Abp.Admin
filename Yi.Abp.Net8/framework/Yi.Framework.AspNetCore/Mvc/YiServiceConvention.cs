...
public class YiServiceConvention : AbpServiceConvention
{
        ...
        ConventionalControllerSetting? configuration)
    {
        ...
        if (remoteServiceAttr != null && !remoteServiceAttr.IsEnabledFor(action.ActionMethod)) return;
    ...
    private void NormalizeAttributeRouteTemplate(SelectorModel selector, string rootPath)
    {
        ...
        if (!template.StartsWith("/")) selector.AttributeRouteModel.Template = $"{rootPath}/{template}";
    }
